...
internal sealed class TrajectoryCatalogStore<T> where T : class
{
    ...
    public TrajectoryCatalogStore(SqlConnectionManager manager, string table, string documentColumn,
    ...
    private bool Write(T value, bool update)
    {
        ...
        command.Parameters.AddWithValue("$meta", JsonSerializer.Serialize(info, JsonSettings.Options));
